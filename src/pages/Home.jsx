          ...
          <div className="md:w-7/12 lg:w-6/12 bg-white/20 backdrop-blur-xl rounded-3xl border border-white/30 shadow-[0_8px_32px_rgba(31,38,135,0.37)] p-8 hover:scale-105 hover:shadow-orange-400/40 transition-all duration-500">
            ...
            <div className="mt-4 text-gray-600">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  Reduce agency dependency and lower execution costs for
                  micro-businesses.
                </li>
                <li>
                  Create structured earning opportunities and an accessible,
                  local digital workforce.
                </li>
                <li>
                  Drive SME growth while establishing a trust-verified execution
                  network.
                </li>
              </ul>
            </div>
